...
public class ClusterBlockDataScreen extends WindowScreen {
    private final ClusterBlockData blockData;
    private final Block block;
    private final BlockDataSetting<ClusterBlockData> setting;

    public ClusterBlockDataScreen(GuiTheme theme, ClusterBlockData blockData, Block block, BlockDataSetting<ClusterBlockData> setting) {
    ...
    public void initWidgets() {
        ...
        sgGeneral.add(new ColorSetting.Builder()
            ...
            .defaultValue(new SettingColor(138, 43, 226, 25))
        ...
        sgTracer.add(new ColorSetting.Builder()
            ...
            .defaultValue(new SettingColor(138, 43, 226, 125))
    ...
    private void changed(ClusterBlockData blockData, Block block, BlockDataSetting<ClusterBlockData> setting) {
