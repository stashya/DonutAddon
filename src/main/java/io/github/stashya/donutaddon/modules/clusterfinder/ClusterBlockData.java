...
public class ClusterBlockData implements ICopyable<ClusterBlockData>, ISerializable<ClusterBlockData>, IChangeable, IBlockData<ClusterBlockData>, IScreenFactory {
    ...
    public ClusterBlockData(ShapeMode shapeMode, SettingColor lineColor, SettingColor sideColor, boolean tracer, SettingColor tracerColor) {
    ...
    @Override
    public WidgetScreen createScreen(GuiTheme theme, Block block, BlockDataSetting<ClusterBlockData> setting) {
        return new ClusterBlockDataScreen(theme, this, block, setting);
    }

    @Override
    public WidgetScreen createScreen(GuiTheme theme) {
        return new ClusterBlockDataScreen(theme, this, null, null);
    }
    ...
    @Override
    public ClusterBlockData set(ClusterBlockData value) {
    ...
    @Override
    public ClusterBlockData copy() {
        return new ClusterBlockData(shapeMode, new SettingColor(lineColor), new SettingColor(sideColor), tracer, new SettingColor(tracerColor));
    }
    ...
    @Override
    public ClusterBlockData fromTag(NbtCompound tag) {
